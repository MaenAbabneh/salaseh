...
function SeatMap({ mapData }: SeatMapProps) {
  ...
  const totalPrice = selectedSeats.reduce((sum, seat) => {
    // Assuming price tiers - you can modify this logic based on your pricing structure
    ...
    return sum + (priceMap[seat.priceTier] || 0);
  }, 0);
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    {(() => {
                      ...
                      return priceMap[seat.priceTier] || 0;
                    })()}
                  </div>
                </div>
              ))}
